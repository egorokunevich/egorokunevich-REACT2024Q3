...
function ErrorPage() {
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsx('h1', {
        className: styles$a.errorTitle,
        children: 'Oops! Something went wrong.',
      }),
      /* @__PURE__ */ jsx('p', {
        className: styles$a.errorInfo,
...
const getSelectedPokemonsSelector = (store2) =>
  store2.pokemons.selectedPokemons;
...
const ThemeToggler = () => {
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$8.themeToggleContainer,
    children: [
      /* @__PURE__ */ jsx('div', {
        className: styles$8.toggleTitle,
        children: 'DARK THEME',
      }),
      /* @__PURE__ */ jsxs('label', {
        className: styles$8.toggleLabel,
        children: [
          /* @__PURE__ */ jsx('input', {
            type: 'checkbox',
            onClick: handleClick,
      ...
      /* @__PURE__ */ jsxs('body', {
        children: [
          /* @__PURE__ */ jsx(Provider, {
            store,
            children: /* @__PURE__ */ jsx(ThemeProvider, { children }),
          }),
...
function App() {
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsx(Header, {
        children: /* @__PURE__ */ jsx(ThemeToggler, {}),
      }),
      /* @__PURE__ */ jsx(Outlet, {}),
    ],
  });
...
const getPokemons = async ({ limit, offset, name: name2 }) => {
...
function DetailsPage() {
  ...
  if (!pokemon) {
    return /* @__PURE__ */ jsx('div', {
      className: styles$6.loaderContainer,
      children: /* @__PURE__ */ jsx(Loader, {}),
    });
  }
  return /* @__PURE__ */ jsx('div', {
    className: styles$6.pageWrapper,
    'data-testid': 'details-page',
    children: /* @__PURE__ */ jsxs('div', {
      className: styles$6.pageContent,
      children: [
        /* @__PURE__ */ jsx('div', {
        ...
        /* @__PURE__ */ jsxs('div', {
          className: styles$6.infoText,
          children: ['Height: ', pokemon.height],
        }),
        /* @__PURE__ */ jsxs('div', {
          className: styles$6.infoText,
...
function SearchBar(props) {
  ...
  return /* @__PURE__ */ jsx('div', {
    className: styles$5.searchWrapper,
    'data-testid': 'search-bar',
    children: /* @__PURE__ */ jsxs('div', {
      className: styles$5.searchBar,
      children: [
        /* @__PURE__ */ jsx('input', {
    ...
    children: [
      /* @__PURE__ */ jsxs('label', {
        ...
        children: [
          ...
          isSelected &&
            /* @__PURE__ */ jsx('div', { className: styles$4.checkboxMarker }),
        ],
      }),
      /* @__PURE__ */ jsx('div', {
      ...
      /* @__PURE__ */ jsx('div', {
        className: styles$4.picContainer,
        children: renderImage(),
      }),
      /* @__PURE__ */ jsxs('p', { children: ['Weight: ', pokemon.weight] }),
      /* @__PURE__ */ jsxs('p', { children: ['Height: ', pokemon.height] }),
    ],
  });
}
...
function ResultsList() {
  ...
  if (!pokemons.length) {
    return /* @__PURE__ */ jsx('div', {
      className: styles$3.notFoundMessage,
      children: 'There is no such Pokemon!',
    });
  }
  return /* @__PURE__ */ jsx('div', {
    className: styles$3.listContainer,
    'data-testid': 'resultsListWrapper',
    children: pokemons.map((item, id) =>
      /* @__PURE__ */ jsx(
        PokeCard,
        {
          pokemon: item,
    ...
    children: /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        /* @__PURE__ */ jsxs('div', {
          ...
          children: ['Pokemons selected: ', selectedPokemons.length],
        }),
        /* @__PURE__ */ jsx(Button, {
          txt: 'Unselect All',
...
function SearchPage() {
  ...
  return /* @__PURE__ */ jsx('div', {
    className: styles$2.pageContainer,
    children: /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        ...
        selectedPokemons.length > 0 &&
          /* @__PURE__ */ jsx(Flyout, { selectedPokemons }),
      ],
    }),
  });
}
const getOffset = (currentPage, limit = PAGE_LIMIT) =>
...
const Details = () => {
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsx(DetailsPage, {}),
  });
};
...
const serverManifest = {
  entry: {
    module: '/assets/entry.client-B7PfUS6I.js',
    imports: ['/assets/components-DaO9B0RH.js'],
    css: [],
  },
  routes: {
    root: {
      ...
      module: '/assets/root-JhooY-Ut.js',
      imports: [
        '/assets/components-DaO9B0RH.js',
        '/assets/selectors-DeimZJVc.js',
        '/assets/reduxHooks-sRxE1122.js',
      ],
      css: ['/assets/selectors-DofpQg-N.css', '/assets/root-D9ZcCA0M.css'],
    },
    'routes/_layout.pokemon.$pokeName': {
      ...
      module: '/assets/_layout.pokemon._pokeName-CB_EG9uo.js',
      imports: [
        '/assets/components-DaO9B0RH.js',
        '/assets/Loader-HfTiRl3h.js',
        '/assets/reduxHooks-sRxE1122.js',
      ],
      css: [
        '/assets/Loader-Bl4uOim5.css',
        '/assets/_layout.pokemon-EKugXUP5.css',
      ],
    },
    'routes/_layout': {
      id: 'routes/_layout',
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/_layout-DYDkhlhM.js',
      imports: [
        '/assets/components-DaO9B0RH.js',
        '/assets/Loader-HfTiRl3h.js',
        '/assets/reduxHooks-sRxE1122.js',
        '/assets/selectors-DeimZJVc.js',
        '/assets/SearchPage-MmmSILWX.js',
      ],
      css: [
        '/assets/Loader-Bl4uOim5.css',
        '/assets/selectors-DofpQg-N.css',
        '/assets/SearchPage-5pDvT2i3.css',
      ],
    },
    'routes/_index': {
      id: 'routes/_index',
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/_index-zj_EL04q.js',
      imports: [
        '/assets/components-DaO9B0RH.js',
        '/assets/Loader-HfTiRl3h.js',
        '/assets/reduxHooks-sRxE1122.js',
  ...
  url: '/assets/manifest-2d39cfb8.js',
  version: '2d39cfb8',
};
